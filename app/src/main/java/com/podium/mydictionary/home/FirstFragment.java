...
import com.podium.mydictionary.databinding.FragmentFirstBinding;
...
public class FirstFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.wordListView.setLayoutManager(new LinearLayoutManager(getActivity()));
        WordListAdapter adapter = new WordListAdapter(getActivity());
        binding.wordListView.setAdapter(adapter);

        viewModel.getAllWords().observe(getActivity(), words -> {
